...
void get_normal(string INPUT_FILE_NAME, string OUTPUT_NAME, float intrinsics[3]){
	//set parameters here:
	cout << intrinsics[0] << " " << intrinsics[1] << " " << intrinsics[2] << endl;
	fcxcy[0]=intrinsics[0];fcxcy[1]=intrinsics[1];fcxcy[2]=intrinsics[2];
	// string INPUT_FILE_NAME = "depth.png";
	// string OUTPUT_NAME = "test.png";
